...
def print_table(
    ...
    row_format = "{:>23} {:>23.10e} {:>24.10e} {:>26.10f}%"
    print()
    ...
    for i in range(5):
        ...
        print(row_format.format(methods_names[i], approximate_value, inaccuracy, relative_inaccuracy * 100))
...
def print_runge_correction(
    ...
    for i in range(5):
        ...
        print(row_format.format(methods_names[i], runge_value, inaccuracy, inaccuracy / abs(accurate_integral) * 100))
